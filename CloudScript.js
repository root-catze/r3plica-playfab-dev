handlers.getPlayerItems = function (args, context) {
    const data = server.GetUserData({PlayFabId:currentPlayerId, Keys:["Data"]});
    const userData = data["Data"]["Data"];
    
    const ItemEntries = JSON.parse(userData["Value"])["ItemEntries"];
    
    return ItemEntries;
}

handlers.getPlayerEntitlements = function (args, context) {
    const data = server.GetUserData({PlayFabId:currentPlayerId, Keys:["Data"]});
    const userData = data["Data"]["Data"];
    
    const Quests = JSON.parse(userData["Value"])["Quests"];
